...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 01 mai 2018 à 20:03
...
--
-- Base de données :  `bd_onf`
--
CREATE DATABASE IF NOT EXISTS `bd_onf` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bd_onf`;
...
--
-- Déchargement des données de la table `domanialite`
--
...
CREATE TABLE `user` (
  ...
  `privilege` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user'
...
INSERT INTO `user` (`id`, `username`, `email`, `password`, `privilege`) VALUES
(1, 'test', 'test@test.com', 'test', 'admin'),
(2, 'test2', 'test2@test2.com', 'test2', 'user'),
(3, 'test3', 'test3@test3.com', 'test3', 'admin'),
(4, 'test4', 'test4@test4.com', 'test4', 'user');
